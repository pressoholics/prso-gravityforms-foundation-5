<?php
class PrsoGravityformsFoundation5 {
	
	protected static $class_config 				= array();
	protected $current_screen					= NULL;
	protected $plugin_ajax_nonce				= 'prso-gravityforms-foundation-5-ajax-nonce';
	protected $plugin_path						= PRSOGFORMSFOUND5__PLUGIN_DIR;
	protected $plugin_url						= PRSOGFORMSFOUND5__PLUGIN_URL;
	protected $plugin_textdomain				= PRSOGFORMSFOUND5__DOMAIN;
	...
	*/
	public function init_plugin() {
		...
		//Include plugin core
		$plugin_core_inc = $this->plugin_path . 'core.prso-gravityforms-foundation-5.php';
		if( file_exists($plugin_core_inc) ) {
			//This core code is procedural i know. But it was part of my theme framework and i wanted to share it :)
			include_once( $plugin_core_inc );
		}
